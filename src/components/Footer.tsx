...
export default function Footer() {
  return (
    <footer class="w-full flex flex-col bg-zinc-900 text-white">
      <div class="w-full max-w-7xl mx-auto px-6 sm:px-10 lg:px-12 py-12 lg:py-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
        <div class="flex flex-col items-center sm:items-start gap-4">
          <img
            ...
            loading="lazy"
          />
          <p class="text-sm text-zinc-400 text-center sm:text-left leading-relaxed">
            Servicios eléctricos integrales en Córdoba. Más de 20 años de experiencia.
          </p>
        </div>

        <nav aria-label="Servicios" class="flex flex-col items-center sm:items-start gap-3">
          <h3 class="text-base font-bold uppercase tracking-wider text-orange-500">Servicios</h3>
          <A href="/electricidad" class="text-sm text-zinc-300 hover:text-orange-400 transition-colors">Electricidad Integral</A>
        ...
        <div class="flex flex-col items-center sm:items-start gap-3">
          <h3 class="text-base font-bold uppercase tracking-wider text-orange-500">Contacto</h3>
          <a href="tel:+543512922784" class="text-sm text-zinc-300 hover:text-orange-400 transition-colors">+54 351-2922784</a>
          <a href="mailto:sesc.especializado@gmail.com" class="text-sm text-zinc-300 hover:text-orange-400 transition-colors break-all">sesc.especializado@gmail.com</a>
          <p class="text-sm text-zinc-400">Córdoba, Argentina</p>
          <a
            class="mt-2 inline-flex justify-center items-center bg-orange-500 px-4 py-2 rounded-md text-sm font-bold hover:bg-orange-600 transition-all"
        ...
        <div class="flex flex-col items-center sm:items-start gap-3">
          <h3 class="text-base font-bold uppercase tracking-wider text-orange-500">Seguinos</h3>
          <div class="flex gap-3">
            <a
              ...
              rel="noopener"
              aria-label="Facebook"
              class="w-10 h-10 rounded-full bg-white/5 hover:bg-orange-500 flex items-center justify-center transition-colors"
            >
            ...
            <a
              href="https://wa.me/543512922784"
              target="_blank"
              rel="noopener"
              aria-label="WhatsApp"
              class="w-10 h-10 rounded-full bg-white/5 hover:bg-green-500 flex items-center justify-center transition-colors"
            >
              <svg class="w-5 h-5" viewBox="0 0 50 50" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      ...
      <div class="w-full bg-zinc-950 text-zinc-400 py-4 text-xs sm:text-sm text-center px-4">
        © {new Date().getFullYear()} SESC — Servicios Especializados S.C. Todos los derechos reservados.
      </div>
    </footer>
  );
}
