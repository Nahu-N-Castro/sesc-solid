    ...
    <footer class="w-full flex flex-col">
      <section
        ...
        <img
          ...
          alt="Logo SESC - Servicios Eléctricos Integrales"
          src="logo.png"
          width="144"
          height="144"
          loading="lazy"
        ...
        <div class="flex flex-col gap-2 items-center sm:items-start">
          <h3 class="text-2xl text-start font-bold uppercase">Seguinos</h3>
        ...
        <div class="flex-col gap-2 flex">
          <h3 class="text-2xl sm:text-start font-bold uppercase">Sobre Nosotros</h3>
          <p class="sm:text-start w-72">Somos una empresa de servicios eléctricos creada y con crecimiento en plena crisis económica, formada por profesionales con más de 20 años de experiencia.</p>
        </div>
      </section>

      <div class="w-full bg-zinc-900 text-white py-3 text-sm text-center">
        © {new Date().getFullYear()} SESC — Servicios Eléctricos Integrales. Todos los derechos reservados.
      </div>
    </footer>
  )
}
